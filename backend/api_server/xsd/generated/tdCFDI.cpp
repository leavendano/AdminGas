...
{
  ::std::ostream&
  operator<< (::std::ostream& o, const t_CURP& i)
  {
  ...
  ::std::ostream&
  operator<< (::std::ostream& o, const t_Importe& i)
  {
  ...
  ::std::ostream&
  operator<< (::std::ostream& o, const t_Fecha& i)
  {
  ...
  ::std::ostream&
  operator<< (::std::ostream& o, const t_ImporteMXN& i)
  {
    o << static_cast< const ::xsd::cxx::tree::fundamental_base< ::xml_schema::decimal, char, ::xml_schema::simple_type, ::xsd::cxx::tree::schema_type::decimal >& > (i);
  ...
  ::std::ostream&
  operator<< (::std::ostream& o, const t_CuentaBancaria& i)
  {
  ...
  ::std::ostream&
  operator<< (::std::ostream& o, const t_RFC& i)
  {
    o << static_cast< const ::xml_schema::string& > (i);
  ...
  ::std::ostream&
  operator<< (::std::ostream& o, const t_RFC_PM& i)
  {
    o << static_cast< const ::xml_schema::string& > (i);
  ...
  ::std::ostream&
  operator<< (::std::ostream& o, const t_RFC_PF& i)
  {
    o << static_cast< const ::xml_schema::string& > (i);
  ...
  ::std::ostream&
  operator<< (::std::ostream& o, const t_FechaHora& i)
  {
  ...
  ::std::ostream&
  operator<< (::std::ostream& o, const t_FechaH& i)
  {
    o << static_cast< const ::xml_schema::date_time& > (i);
  ...
  ::std::ostream&
  operator<< (::std::ostream& o, const t_Descrip100& i)
  {
    o << static_cast< const ::xml_schema::string& > (i);
  ...
  ::std::ostream&
  operator<< (::std::ostream& o, const t_NumeroDomicilio& i)
  {
    o << static_cast< const ::xml_schema::string& > (i);
  ...
  ::std::ostream&
  operator<< (::std::ostream& o, const t_Referencia& i)
  {
    o << static_cast< const ::xml_schema::string& > (i);
  ...
  ::std::ostream&
  operator<< (::std::ostream& o, const t_Descrip120& i)
  {
    o << static_cast< const ::xml_schema::string& > (i);
  ...
  ::std::ostream&
  operator<< (::std::ostream& o, const t_TipoCambio& i)
  {
    o << static_cast< const ::xsd::cxx::tree::fundamental_base< ::xml_schema::decimal, char, ::xml_schema::simple_type, ::xsd::cxx::tree::schema_type::decimal >& > (i);
